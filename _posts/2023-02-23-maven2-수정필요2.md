...
번외 - pom.xml의 Cannot access defaults field of Properties 에러 해결 방법   
...
<img src="/assets/images/Maven2.JPG" width="100%" height="100%" title="참고 이미지" alt="이미지" />
...
or   
Maven Project 우클릭 → Maven → Add Dependency   
에서 Library 검색
